...
int main(){
    ...
    superPoder = (float) (populacao1+area1+pib1+Pib_Per_Capta1+turismo1+ 1 / Densidade_Populacional1);
    ...
    superPoder = (float) (populacao2+pib2+Pib_Per_Capta2+turismo2+ 1 / Densidade_Populacional2);
    ...
    printf("populacao1 (%d) e maior que populacao2 (%d) ?: %d\n", resultado, populacao1, populacao2);
    printf("area1 (%.2f) e diferente de area2 (%.2f) ?: %d\n",resultado, area1, area2);
    printf("densidade populacional1 (%.2f) e menor que densidade populacional2 (%.2f): ? %d\n",resultado, Densidade_Populacional1, Densidade_Populacional2);
    printf("pib1 (%.2f) e igual a pib2 (%.2f) ?: %d\n", resultado, pib1, pib2);
